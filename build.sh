...
# sched模块
out_files+=(sched/mutex/mtx_lock_c.s sched/mutex/mtx_trylock_c.s sched/mutex/empty_switch.s sched/mutex/timer_isr.s sched/mutex/set_thread_schedulable.s sched/mutex/new_thread_isr.s
