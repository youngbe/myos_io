...
# %bb.0:
	...
	movq	%gs:0, %rsi
	#NO_APP
	leaq	keyboard_buf(%rip), %r10
	leaq	to_ascii_cap(%rip), %r11
	leaq	to_ascii(%rip), %r12
	leaq	keymap(%rip), %r13
...
.LBB0_37:                               #   in Loop: Header=BB0_29 Depth=3
	...
	testb	%dil, %dil
	je	.LBB0_28
# %bb.38:                               #   in Loop: Header=BB0_29 Depth=3
...
# %bb.46:                               #   in Loop: Header=BB0_5 Depth=2
	...
	testb	%cl, %cl
	jne	.LBB0_18
# %bb.47:                               #   in Loop: Header=BB0_5 Depth=2
	cmpq	$32, %r13
	jae	.LBB0_70
...
.LBB0_52:                               #   in Loop: Header=BB0_5 Depth=2
	...
	testq	%rax, %rax
	je	.LBB0_61
# %bb.53:                               #   in Loop: Header=BB0_5 Depth=2
...
.LBB0_57:                               #   in Loop: Header=BB0_5 Depth=2
	testq	%r13, %r13
	je	.LBB0_61
# %bb.58:                               #   in Loop: Header=BB0_5 Depth=2
...
.LBB0_62:                               #   in Loop: Header=BB0_5 Depth=2
	...
	leaq	keymap(%rip), %r13
	jne	.LBB0_82
.LBB0_63:                               #   in Loop: Header=BB0_5 Depth=2
...
# %bb.69:                               #   in Loop: Header=BB0_66 Depth=3
	movq	%r13, %r8
	jmp	.LBB0_65
.LBB0_70:                               #   in Loop: Header=BB0_5 Depth=2
	movq	%r13, %rax
	andq	$-32, %rax
	movq	%rax, %rcx
	movq	%rsi, %rdx
...
.LBB0_71:                               #   Parent Loop BB0_1 Depth=1
	...
	addq	$-32, %rcx
	jne	.LBB0_71
# %bb.72:                               #   in Loop: Header=BB0_5 Depth=2
	cmpq	%rax, %r13
	je	.LBB0_23
