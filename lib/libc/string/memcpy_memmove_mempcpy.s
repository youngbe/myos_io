# 此文件引用自glibc源代码
# glibc-2.37 中的 sysdeps/x86_64/multiarch/memmove-avx-unaligned-erms.S
# 链接： https://elixir.bootlin.com/glibc/glibc-2.37/source/sysdeps/x86_64/multiarch/memmove-avx-unaligned-erms.S
# memmove-avx-unaligned-erms.S -> memmove.s 编译命令： 在构建glibc时，运行make命令期间，找到编译sysdeps/x86_64/multiarch/memmove-avx-unaligned-erms.S 文件的命令，将 -c 选项修改为 -E 选项，即可获得编译后的汇编文件 
    .set __x86_rep_movsb_threshold, 0x2000
    .set __x86_rep_movsb_stop_threshold, 0xc0000
    .set __x86_shared_non_temporal_threshold, 0xc0000
    .set __x86_string_control, 0
    .code64
    .section .text.mempcpy,"ax",@progbits
    .globl mempcpy
...
.Llast_4x_vec:
 ...
 .p2align 4
.Lmovsb_more_2x_vec:
 cmp $__x86_rep_movsb_threshold, %rdx
 ja .Lmovsb
.Lmore_2x_vec:
 cmpq $(32 * 8), %rdx
 ja .Lmore_8x_vec
...
.Lmore_8x_vec:
 ...
 cmp $__x86_shared_non_temporal_threshold, %rdx
 ja .Llarge_memcpy_2x
.Lmore_8x_vec_check:
 leaq (%rcx, %rdx), %r8
 xorq %rcx, %r8
...
.Lmovsb:
 ...
 jb .Lmore_8x_vec_backward_check_nop
 movq %rdi, %r8
 cmp $__x86_rep_movsb_stop_threshold, %rdx
 jae .Llarge_memcpy_2x_check
 .ifeq (1 << 0) & __x86_string_control
 jmp .Lskip_short_movsb_check
 .endif
.Lmovsb_align_dst:
 subq %rdi, %rsi
 addq $(64 - 1), %rdi
...
.Llarge_memcpy_2x:
 mov $__x86_shared_non_temporal_threshold, %r11
 cmp %r11, %rdx
...
.Lloop_large_memcpy_2x_inner:
 prefetcht0 ((32 * 4))(%rsi)
 prefetcht0 ((32 * 4) + 1 * 64)(%rsi)
 prefetcht0 ((32 * 4) * 2)(%rsi)
 prefetcht0 ((32 * 4) * 2 + 1 * 64)(%rsi)
 prefetcht0 (4096 + (32 * 4))(%rsi)
 prefetcht0 (4096 + (32 * 4) + 1 * 64)(%rsi)
 prefetcht0 (4096 + (32 * 4) * 2)(%rsi)
 prefetcht0 (4096 + (32 * 4) * 2 + 1 * 64)(%rsi)
 vmovdqu (0)(%rsi), %ymm0
 vmovdqu ((0) + 32)(%rsi), %ymm1
 vmovdqu ((0) + 32 * 2)(%rsi), %ymm2
 vmovdqu ((0) + 32 * 3)(%rsi), %ymm3
 vmovdqu (4096)(%rsi), %ymm4
 vmovdqu ((4096) + 32)(%rsi), %ymm5
 vmovdqu ((4096) + 32 * 2)(%rsi), %ymm6
 vmovdqu ((4096) + 32 * 3)(%rsi), %ymm7
 subq $-(32 * 4), %rsi
 vmovntdq %ymm0, (0)(%rdi)
 vmovntdq %ymm1, ((0) + 32)(%rdi)
 vmovntdq %ymm2, ((0) + 32 * 2)(%rdi)
 vmovntdq %ymm3, ((0) + 32 * 3)(%rdi)
 vmovntdq %ymm4, (4096)(%rdi)
 vmovntdq %ymm5, ((4096) + 32)(%rdi)
 vmovntdq %ymm6, ((4096) + 32 * 2)(%rdi)
 vmovntdq %ymm7, ((4096) + 32 * 3)(%rdi)
 subq $-(32 * 4), %rdi
 decl %ecx
...
.Lloop_large_memcpy_4x_inner:
 ...
 prefetcht0 (4096 + (32 * 4))(%rsi)
 prefetcht0 (4096 + (32 * 4) + 1 * 64)(%rsi)
 prefetcht0 (4096 * 2 + (32 * 4))(%rsi)
 prefetcht0 (4096 * 2 + (32 * 4) + 1 * 64)(%rsi)
 prefetcht0 (4096 * 3 + (32 * 4))(%rsi)
 prefetcht0 (4096 * 3 + (32 * 4) + 1 * 64)(%rsi)
 ...
 vmovdqu ((4096) + 32 * 2)(%rsi), %ymm6
 vmovdqu ((4096) + 32 * 3)(%rsi), %ymm7
 vmovdqu (4096 * 2)(%rsi), %ymm8
 vmovdqu ((4096 * 2) + 32)(%rsi), %ymm9
 vmovdqu ((4096 * 2) + 32 * 2)(%rsi), %ymm10
 vmovdqu ((4096 * 2) + 32 * 3)(%rsi), %ymm11
 vmovdqu (4096 * 3)(%rsi), %ymm12
 vmovdqu ((4096 * 3) + 32)(%rsi), %ymm13
 vmovdqu ((4096 * 3) + 32 * 2)(%rsi), %ymm14
 vmovdqu ((4096 * 3) + 32 * 3)(%rsi), %ymm15
 subq $-(32 * 4), %rsi
 vmovntdq %ymm0, (0)(%rdi)
 vmovntdq %ymm1, ((0) + 32)(%rdi)
 vmovntdq %ymm2, ((0) + 32 * 2)(%rdi)
 ...
 vmovntdq %ymm6, ((4096) + 32 * 2)(%rdi)
 vmovntdq %ymm7, ((4096) + 32 * 3)(%rdi)
 vmovntdq %ymm8, (4096 * 2)(%rdi)
 vmovntdq %ymm9, ((4096 * 2) + 32)(%rdi)
 vmovntdq %ymm10, ((4096 * 2) + 32 * 2)(%rdi)
 vmovntdq %ymm11, ((4096 * 2) + 32 * 3)(%rdi)
 vmovntdq %ymm12, (4096 * 3)(%rdi)
 vmovntdq %ymm13, ((4096 * 3) + 32)(%rdi)
 vmovntdq %ymm14, ((4096 * 3) + 32 * 2)(%rdi)
 vmovntdq %ymm15, ((4096 * 3) + 32 * 3)(%rdi)
 subq $-(32 * 4), %rdi
 decl %ecx
