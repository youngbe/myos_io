...
double __musl_sin(double,double,int);
double __musl_cos(double,double);
double __musl_tan(double,double,int);
...
long double __musl_sinl(long double, long double, int);
long double __musl_cosl(long double, long double);
long double __musl_tanl(long double, long double, int);
